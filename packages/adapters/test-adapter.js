...
function test() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    adapter = new AntigravityAdapter_1.AntigravityAdapter();
                    ...
                    return [4 /*yield*/, adapter.start({
                            ...
                            onExit: function (code) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2 /*return*/, console.log("EXIT:", code)];
                            }); }); }
                        })];
                case 1:
                    _a.sent();
