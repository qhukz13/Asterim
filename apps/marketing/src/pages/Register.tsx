...
export const Register: React.FC<RegisterProps> = ({ navigate, onLoginSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const targetUrl = isDevPort ? 'http://localhost:3000/api/v1/auth/register' : '/api/v1/auth/register';
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ color: '#94a3b8', fontSize: '0.95rem', margin: 0 }}>
            Join Asterim and start orchestrating software engineering agents
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '0.25rem' }}>
            ...
            />
            <label htmlFor="terms" style={{ color: '#94a3b8', fontSize: '0.85rem', cursor: 'pointer' }}>
