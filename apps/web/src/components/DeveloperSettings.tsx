                    ...
                    <div style={{ display: 'flex', gap: '8px' }}>
                      {config.preferredWorkstationId === w.id ? (
                        ...
                        <button
                          ...
                          onClick={() => setActiveWorkstation(w.id)}
                        >
                          Connect
                        </button>
                      )}
                  ...
                  >
                    <div>
                      ...
                      <div
                        style={{
                          fontSize: '0.75rem',
                          color: w.isOnline ? 'var(--success-color)' : 'var(--error-color)'
                        }}
                      >
                    ...
                    <div style={{ display: 'flex', gap: '8px' }}>
                      ...
                      <button
                        className="btn-deny"
                        style={{ padding: '6px 12px', fontSize: '0.8rem' }}
                        onClick={() => forgetWorkstation(w.id)}
                      >
                        Forget
                      </button>
                    </div>
          ...
          {config.preferredWorkstationId && (
            <div style={{ marginTop: '12px' }}>
              <button
                ...
                onClick={() => setActiveWorkstation(undefined)}
              >
