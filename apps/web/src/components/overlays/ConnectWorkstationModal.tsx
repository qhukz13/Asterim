...
export function ConnectWorkstationModal({
  workstations,
  onClose,
  onConnectRemote
}: ConnectWorkstationModalProps) {
  const {
    config,
    discovered,
    activeWorkstation,
    ...
    <div className="dialog-overlay" onClick={onClose}>
      ...
      >
        ...
        <div>
          ...
          <p
            style={{ fontSize: '0.85rem', color: 'var(--color-text-muted)', marginBottom: '12px' }}
          >
            Enter the Tunnel ID and PIN from the target workstation.
          </p>
