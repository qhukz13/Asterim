...
- **Symptom**: Selecting `"⚙ Workspace & Team View"` from the workspace dropdown does not display the full workspace view when no project or thread is actively selected in the router state.
- **Root Cause**:
