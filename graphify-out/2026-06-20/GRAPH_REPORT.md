# Graph Report - AgentDeck  (2026-06-20)

## Corpus Check
- 84 files · ~71,432 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 720 nodes · 830 edges · 54 communities (40 shown, 14 thin omitted)
...
1. `AgentDeckEvent` - 22 edges
2. `compilerOptions` - 17 edges
3. `compilerOptions` - 16 edges
4. `AgentDeck Architecture` - 16 edges
5. `AgentDeck — Launch Readiness Audit` - 16 edges
6. `EventBus` - 14 edges
7. `PairingService` - 13 edges
8. `AiderAdapter` - 13 edges
9. `ClaudeAdapter` - 13 edges
...
Cohesion: 0.05
Nodes (24): fastify, start(), Architecture Specification, authMiddleware, authRoutes(), projectRoutes(), systemRoutes(), PendingApproval (+16 more)

### Community 1 - "Relay & WebSockets"
Cohesion: 0.06
Nodes (33): fastify, RelayClient, arrayBufferToBase64(), base64ToArrayBuffer(), decryptPayload(), deriveSharedSecret(), EncryptedPayload, encryptPayload() (+25 more)
...
Cohesion: 0.04
Nodes (43): Adapter System Design, AgentDeck Architecture, API Design, Database Strategy, Deployment Strategy, Event System Design, Future Cloud Synchronization Strategy, High Level Diagram (+35 more)
...
## Knowledge Gaps
- **417 isolated node(s):** `name`, `private`, `version`, `type`, `dev` (+412 more)
...
- **Why does `PairingService` connect `Authentication & Projects API` to `Server Core & Services`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `ClaudeAdapter` connect `Community 49` to `Server Core & Services`?**
